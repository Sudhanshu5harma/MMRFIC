START_DIR = C:\Users\SUDHAN~1\DOCUME~1\GitHub\MMRFIC\Matlab Working\CholeskyDecomposition\codegen\Inverse\fixpt

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2018a
MAKEFILE = Inverse_float_mex_mex.mk

include Inverse_float_mex_mex.mki


SRC_FILES =  \
	Inverse_float_mex_mexutil.c \
	Inverse_float_mex_data.c \
	Inverse_float_mex_initialize.c \
	Inverse_float_mex_terminate.c \
	Inverse.c \
	logStmts.c \
...
SYS_INCLUDE += -I"$(START_DIR)\fxptmp\Inverse"
...
%.$(OBJEXT) : $(START_DIR)\fxptmp\Inverse/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
