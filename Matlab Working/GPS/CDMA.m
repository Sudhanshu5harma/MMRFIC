...
for i=1:N
  g1_f= [ g1_f g1(10) ];
  xor1=xor(g1(1),g1(4));xor2=xor(g1(6),g1(7));xor3=xor(g1(9),g1(10));
  g1_temp=xor(xor(xor1,xor2),xor3);
  g1(2:n)=g1(1:n-1);
  g1(1)=g1_temp;
  g2_f= [ g2_f g2(10) ];
  g2_temp = xor(xor(xor(g2(3),g2(4)),xor(g2(5),g2(6))),xor(xor(g2(7),g2(8)),xor(g2(9),g2(10))));
  g2(2:n)=g2(1:n-1);
  g2(1)=g2_temp; 
end
...
absolute_auto_correlation = sum(xcorr(polar_gcode));
